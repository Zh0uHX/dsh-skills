      ...
      try {
        ...
        switch (action) {
          case "/details":
            ...
            break;
          case "/install":
            reply(res, 200, { skill: await store.install(skillOf(body.skill), confirmed) });
            break;
          case "/check-updates":
            reply(res, 200, { updates: await store.checkUpdates() });
            break;
          case "/update":
            reply(res, 200, { skill: await store.update(idOf(body), confirmed) });
            break;
          case "/uninstall":
            await store.uninstall(idOf(body), confirmed);
